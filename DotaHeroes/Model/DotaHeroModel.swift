...
enum DotaRole: String, Codable, CaseIterable {
    case carry = "Carry"
...
public struct DotaHeroDetailModel: Codable {
    let id : Int
    let img : String
    let summary : DotaHeroDetailSummary
    let attackType: AttackType
    let base: DotaHeroDetailBase
    let moveSpeed: Int
    let roles: [DotaRole]
}

public struct DotaHeroDetailSummary: Codable {
    let name : String
    let icon : String
    let attr : PrimaryAttr
}

public struct DotaHeroDetailBase: Codable {
    let health : Int
    let mana : Int
    let armor : Double
    let attack : String
